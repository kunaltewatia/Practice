...
Devise.setup do |config|
  ...
  config.mailer_sender = 'no-reply@frools.com'
  ...
  # only for the
  # given strategies, for example, `config.params_
  # authenticatable = [:database]` will
  ...
  # config.pepper = '9d116657cb2ef3cd32de5576a1a1905c3e40e01157a78f21e8cbab95cb
  # 188e2834de30e120e16f768ea13f9e6e16f9ac0c4bf19d9524a0120c7fae39cccb3397'
